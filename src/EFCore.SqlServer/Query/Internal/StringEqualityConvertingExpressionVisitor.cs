    ...
    public class StringEqualityConvertingExpressionVisitor : ExpressionVisitor
    {
        ...
        protected override Expression VisitExtension(Expression extensionExpression)
        {
            ...
            if (extensionExpression is SqlBinaryExpression binaryExpression
                ...
                // elsewhere and rewriting interferes
                && (!(binaryExpression.Left is SqlConstantExpression)
                    || !(binaryExpression.Right is SqlConstantExpression)))
            {
                // var likeExpression = ShouldUseLike(binaryExpression.Right)
                //     ? _sqlExpressionFactory.Like(binaryExpression.Left, binaryExpression.Right)
                //     : ShouldUseLike(binaryExpression.Left)
                //         ? _sqlExpressionFactory.Like(binaryExpression.Right, binaryExpression.Left)
                //         : null;

                var likeExpression =
                    TransformToLike(binaryExpression.Left, binaryExpression.Right) ??
                    TransformToLike(binaryExpression.Right, binaryExpression.Left);
        ...
        // private bool ShouldUseLike(SqlExpression operandExpression)
        //     => operandExpression is SqlConstantExpression constantExpression
        ...
        private LikeExpression TransformToLike(SqlExpression left, SqlExpression right)
